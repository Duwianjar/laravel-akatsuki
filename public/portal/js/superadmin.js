...
var informasi0 = document.getElementById("data-pembayaran-spp");
var informasi1 = document.getElementById("data-jadwal-kelas");
var informasi2 = document.getElementById("data-praktek");
var informasi3 = document.getElementById("data-uts-uas");
...
if (profile && informasi0) {
    ...
    if (profileHeight > informasiHeight) {
        ...
        informasi3.style.height = profileHeight + "px";
...
function addRowClass() {
    ...
    var infor = [
        document.getElementById("data-pembayaran-spp"),
        document.getElementById("data-jadwal-kelas"),
        document.getElementById("data-praktek"),
        document.getElementById("data-uts-uas"),
    ];
...
window.location.href = "/profil#data-pembayaran-spp";
